        ...
        'nav-sticky': scrollY >= 50
          ...
          <ul className="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
            ...
            <li className="mx-3 welcome-text">
              <h3 className="mb-0 fw-bold text-truncate">Bonjour, Nizar!</h3>
            </li>
          </ul>
          <ul className="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
            <li className="hide-phone app-search">
              <form role="search" action="#" method="get">
                <input type="search" name="search" className="form-control top-search mb-0" placeholder="Lancez un recherche..." />
                <button type="button">
