  ...
  return <Card>
      <CardBody>
        <Row className="align-items-center">
          <Col>
            <p className="text-dark mb-0 fw-semibold fs-14">Tâche par jour</p>
            <h2 className="mt-0 mb-0 fw-bold">20</h2>
          </Col>
          <Col xs={'auto'} className="align-self-center">
            <div className="img-group d-flex">
              {users.map((user, idx) => <Link className="user-avatar position-relative d-inline-block ms-n2" href="" key={idx}>
            ...
            <small className="text-muted ms-0">Agent affectés</small>
          </Col>
        </Row>
        ...
        <button type="button" className="btn btn-primary w-100 btn-lg fs-14 flex-centered gap-1">
          Plus de details <IconifyIcon icon="fa6-solid:arrow-right-long" className="" />
        </button>
      </CardBody>
    </Card>;
};
