...
const DefaultMap = ({
  ...
  return <ComponentContainerCard title="Default Map">
      ...
      overflow: 'hidden'
        ...
        lat: 33.886917, // Latitude of Tunisia
        lng: 9.537499  // Longitude of Tunisia
      }} zoomControlOptions={{
        position: google.maps.ControlPosition.LEFT_TOP
      }} zoom={6} />  {/* Adjust the zoom level to 6 to show Tunisia */}
      </div>
...
const MapWithMarkers = ({
  ...
  return <ComponentContainerCard title="Map With Marker">
      ...
      overflow: 'hidden'
        ...
        <Map google={google} zoom={12} initialCenter={{
        ...
        position: google.maps.ControlPosition.LEFT_TOP
          ...
          <Marker title={'Capital of Tunisia - Tunis'} name={'Tunis'} position={{
          lat: 36.8065,
          lng: 10.1815
        }} onClick={onMarkerClick}></Marker>

          <Marker name="Sousse" title={'Sousse, Tunisia'} position={{
          lat: 35.8256,
          lng: 10.6417
        }} onClick={onMarkerClick}></Marker>
